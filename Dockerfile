...
ARG REPOSITORY_NAME=tgrall-octodemo/calculator-service
...
COPY target/calculator-service-1.0.0-SNAPSHOT.jar calculator-service.jar
...
LABEL org.opencontainers.image.authors="GitHub Solutions Engineering" \
    ...
    org.opencontainers.image.title="GitHub Solutions Engineering Calculator" \
